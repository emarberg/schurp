...
from stable.vst import combine_str, ValuedSetTableau
from stable.partitions import Partition
from stable.polynomials import Polynomial
from stable.utils import beta, jp_expansion, jp, jq_expansion, jq
import traceback


def test_rectangle_error():
    tab = {(1, 5): 1, (1, 6): 1, (1, 7): 1, (2, 5): 2, (2, 6): 2, (2, 7): 2, (3, 5): 5, (3, 6): 5, (3, 7): 5, (4, 5): 6, (4, 6): 6, (4, 7): 6}
    grp = {(1, 5): 0, (1, 6): 0, (1, 7): 0, (2, 5): 0, (2, 6): 0, (2, 7): 0, (3, 5): 0, (3, 6): 0, (3, 7): 0, (4, 5): 0, (4, 6): 0, (4, 7): 0}
    tab = ValuedSetTableau(tab, grp)
    res = tab.promotion(n=6, iterations=2)
    oth = tab.promotion(n=6, iterations=3)
    print(tab)
    print(res)
    print(oth)

    tab = {(1, 1): -2, (1, 2): 2, (1, 3): -3, (1, 4): -5, (1, 5): 5, (2, 2): -3, (2, 3): 3, (2, 4): 5, (3, 3): 5}
    grp = {ij: 0 for ij in tab}
    tab = ValuedSetTableau(tab, grp)
    res = tab.promotion(n=6, iterations=2)
    oth = tab.promotion(n=6, iterations=3)
    print(tab)
